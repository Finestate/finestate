            ...
            {open && (
              ...
              <div className="grid grid-cols-3 items-start gap-1.5 border-t border-[#C1440E] bg-white px-2 py-1.5">
                <div
                  ...
                  className="grid auto-rows-min grid-cols-1 content-start items-start gap-1 self-stretch border-4 border-[#C1440E] p-1.5"
                >
                  {meetings.map((m, mi) => (
                    <div
                      key={m.id}
                ...
                {["core", "rest"].map((g) => (
                  <div key={g} className="self-stretch border-4 border-[#C1440E] p-1.5">
